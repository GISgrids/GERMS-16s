...
WorkflowAmpliconrrnaseq.initialise(params, log)
...
workflow AMPLICONRRNASEQ {
    ...
    // MODULE: MultiQC
    //
    workflow_summary    = WorkflowAmpliconrrnaseq.paramsSummaryMultiqc(workflow, summary_params)
